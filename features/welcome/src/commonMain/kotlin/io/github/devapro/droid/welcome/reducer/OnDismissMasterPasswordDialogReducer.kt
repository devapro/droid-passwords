...
class OnDismissMasterPasswordDialogReducer :
    Reducer<WelcomeScreenAction.OnDismissMasterPasswordDialog, WelcomeScreenState, WelcomeScreenAction, WelcomeScreenEvent> {

    override val actionClass = WelcomeScreenAction.OnDismissMasterPasswordDialog::class

    override suspend fun reduce(
        action: WelcomeScreenAction.OnDismissMasterPasswordDialog,
        ...
        return if (currentState is WelcomeScreenState.Success) {
            Reducer.Result(currentState.copy(isMasterPasswordDialogVisible = false, restoreError = null))
        } else {
