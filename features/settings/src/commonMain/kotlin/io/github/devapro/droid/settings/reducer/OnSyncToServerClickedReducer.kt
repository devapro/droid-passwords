...
class OnSyncToServerClickedReducer :
    Reducer<SettingsScreenAction.OnSyncToServerClicked, SettingsScreenState, SettingsScreenAction, SettingsScreenEvent> {

    override val actionClass = SettingsScreenAction.OnSyncToServerClicked::class

    override suspend fun reduce(
        action: SettingsScreenAction.OnSyncToServerClicked,
